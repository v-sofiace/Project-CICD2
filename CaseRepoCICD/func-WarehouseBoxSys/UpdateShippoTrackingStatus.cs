...
{
    public class UpdateShippoTrackingStatus
    {
        private readonly ILogger<UpdateShippoTrackingStatus> _logger;
        ...
        public UpdateShippoTrackingStatus(ILogger<UpdateShippoTrackingStatus> logger, 
        ...
        [Function(nameof(UpdateShippoTrackingStatus))]
        public async Task Run([QueueTrigger("%NotificationQueueName%", Connection = "AzureWebJobsStorage")] QueueMessage message)
        {
            try
            {
                _logger.LogInformation($"UpdateShippoTrackingStatus Queue trigger function processed: {message.MessageText}");
