...
{
    public class RetryNotificationsInFailedQueue
    {
        private readonly ILogger<RetryNotificationsInFailedQueue> _logger;
        ...
        public RetryNotificationsInFailedQueue(ILogger<RetryNotificationsInFailedQueue> logger,
        ...
        [Function(nameof(RetryNotificationsInFailedQueue))]
        public async Task Run([QueueTrigger("%FailedQueueName%", Connection = "AzureWebJobsStorage")] QueueMessage message)
        {
            try
            {
                _logger.LogInformation($"RetryNotificationsInFailedQueue Queue trigger function processed: {message.MessageText}");
                ...
                {
                    // Send the message to the Manual Queue items queue
